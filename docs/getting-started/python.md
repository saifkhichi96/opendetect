...
- registry IDs: `rfdetr-n`, `rfdetr-s`, `rfdetr-m`, `rfdetr-l`, `yolox-tiny`, `yolox-s`, `yolox-m`, `yolox-l`, `yolox-x`, `rtmdet-n-hand`, `rtmdet-s`, `rtmdet-m`, `rtmdet-l`, `bytetrack-s`, `bytetrack-m`, `bytetrack-l`
- implementation names: `rfdetr`, `yolox`, `rtmdet`, `bytetrack` (maps to project defaults)
